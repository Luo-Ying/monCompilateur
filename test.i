...
# 109 "/usr/include/c++/10/ext/numeric_traits.h" 3
  template<typename _Value>
...
# 23 "compilateur.cpp" 2
# 1 "/usr/include/c++/10/cstdlib" 1 3
# 39 "/usr/include/c++/10/cstdlib" 3
       
# 40 "/usr/include/c++/10/cstdlib" 3
# 24 "compilateur.cpp" 2
...
# 785 "/usr/include/c++/10/bits/stl_tree.h" 3
 return _KeyOfValue()(*__x->_M_valptr());
    ...
    public:
      ...
      typedef std::reverse_iterator<iterator> reverse_iterator;
      typedef std::reverse_iterator<const_iterator> const_reverse_iterator;
# 838 "/usr/include/c++/10/bits/stl_tree.h" 3
...
# 1610 "/usr/include/c++/10/bits/stl_tree.h" 3
      friend bool
...
# 1627 "/usr/include/c++/10/bits/stl_tree.h" 3
      friend bool
      operator<(const _Rb_tree& __x, const _Rb_tree& __y)
      {
...
# 2641 "/usr/include/c++/10/bits/stl_tree.h" 3
...
# 1021 "/usr/include/c++/10/bits/stl_set.h" 3
  template<typename _Key, typename _Compare, typename _Alloc>
    inline bool
    operator<(const set<_Key, _Compare, _Alloc>& __x,
       const set<_Key, _Compare, _Alloc>& __y)
...
# 1084 "/usr/include/c++/10/bits/stl_set.h" 3
...
# 969 "/usr/include/c++/10/bits/stl_multiset.h" 3
  template<typename _Key, typename _Compare, typename _Alloc>
    ...
    { return __x._M_t == __y._M_t; }
# 1007 "/usr/include/c++/10/bits/stl_multiset.h" 3
  template<typename _Key, typename _Compare, typename _Alloc>
    inline bool
    operator<(const multiset<_Key, _Compare, _Alloc>& __x,
       const multiset<_Key, _Compare, _Alloc>& __y)
...
# 1072 "/usr/include/c++/10/bits/stl_multiset.h" 3
...
# 63 "/usr/include/c++/10/bits/stl_map.h" 3
...
# 64 "/usr/include/c++/10/bits/stl_map.h" 2 3
...
# 1461 "/usr/include/c++/10/bits/stl_map.h" 3
  template<typename _Key, typename _Tp, typename _Compare, typename _Alloc>
    ...
    { return __x._M_t == __y._M_t; }
# 1499 "/usr/include/c++/10/bits/stl_map.h" 3
  template<typename _Key, typename _Tp, typename _Compare, typename _Alloc>
    inline bool
    operator<(const map<_Key, _Tp, _Compare, _Alloc>& __x,
       const map<_Key, _Tp, _Compare, _Alloc>& __y)
...
# 1565 "/usr/include/c++/10/bits/stl_map.h" 3
...
# 1126 "/usr/include/c++/10/bits/stl_multimap.h" 3
  template<typename _Key, typename _Tp, typename _Compare, typename _Alloc>
    ...
    { return __x._M_t == __y._M_t; }
# 1164 "/usr/include/c++/10/bits/stl_multimap.h" 3
  template<typename _Key, typename _Tp, typename _Compare, typename _Alloc>
    inline bool
    operator<(const multimap<_Key, _Tp, _Compare, _Alloc>& __x,
       const multimap<_Key, _Tp, _Compare, _Alloc>& __y)
...
# 1230 "/usr/include/c++/10/bits/stl_multimap.h" 3

}
# 63 "/usr/include/c++/10/map" 2 3
# 26 "compilateur.cpp" 2
...
# 27 "compilateur.cpp" 2
# 1 "tokeniser.h" 1



# 3 "tokeniser.h"
enum TOKEN {FEOF, UNKNOWN, NUMBER, ID, STRINGCONST, CHARCONST, RBRACKET, LBRACKET, RPARENT, LPARENT, COMMA,
SEMICOLON, COLON, DOT, ADDOP, MULOP, RELOP, NOT, ASSIGN, KEYWORD, TYPE};
# 28 "compilateur.cpp" 2
